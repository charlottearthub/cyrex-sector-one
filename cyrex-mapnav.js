(function(){
  ...
  function d(){return (typeof activeDistrict==='function')?activeDistrict():null}
  ...
  function mapSubtitle(){return mapMode==='sector'?'Tap a district to travel.':districtById(activeId()).status+' · tap a map point to act.'}
